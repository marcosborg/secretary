    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.publishers.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('emergency') ? 'is-invalid' : '' }}" type="text" name="emergency" id="emergency" value="{{ old('emergency', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('celphone') ? 'is-invalid' : '' }}" type="text" name="celphone" id="celphone" value="{{ old('celphone', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('baptism') ? 'is-invalid' : '' }}" type="text" name="baptism" id="baptism" value="{{ old('baptism') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('birth') ? 'is-invalid' : '' }}" type="text" name="birth" id="birth" value="{{ old('birth') }}">
                @if($errors->has('birth'))
                    <div class="invalid-feedback">
                        {{ $errors->first('birth') }}
                    </div>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('rgpd') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="rgpd" id="rgpd" value="1" {{ old('rgpd', 0) == 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('dav') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="dav" id="dav" value="1" {{ old('dav', 0) == 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('dav_expiration') ? 'is-invalid' : '' }}" type="text" name="dav_expiration" id="dav_expiration" value="{{ old('dav_expiration') }}">
