...
<div class="card">
    ...
    <div class="card-body">
        <div class="table-responsive">
            <table class=" table table-bordered table-striped table-hover datatable datatable-assignmentsStudents">
                <thead>
                    <tr>
                        <th width="10">
                ...
                <tbody>
                    @foreach($students as $key => $student)
                        <tr data-entry-id="{{ $student->id }}">
                            ...
                            <td>
                                @foreach($student->assignments as $key => $item)
...
@endcan
  ...
  let table = $('.datatable-assignmentsStudents:not(.ajaxTable)').DataTable({ buttons: dtButtons })
