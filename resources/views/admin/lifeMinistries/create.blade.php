...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.lifeMinistry.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.life-ministries.store") }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('disabled') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="disabled" id="disabled" value="1" {{ old('disabled', 0) == 1 ? 'checked' : '' }}>
