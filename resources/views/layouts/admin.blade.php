...
<head>
  ...
  <link href="https://cdnjs.cloudflare.com/ajax/libs/jquery.perfect-scrollbar/1.5.0/css/perfect-scrollbar.min.css"
    rel="stylesheet" />
  <link href="{{ asset('css/custom.css') }}?v={{ rand() }}" rel="stylesheet" />
  @yield('styles')
</head>
  ...
  <div class="c-wrapper">
    <header class="c-header c-header-fixed px-3">
      ...
      <ul class="c-header-nav ml-auto">
        ...
        <ul class="c-header-nav ml-auto">
          @can('maintenance_mode')
          <li class="c-header-nav-item">
            @if (Storage::disk('framework')->exists('/down'))
              <a href="/admin/maintenance/up" class="c-header-nav-link">Up</a>    
            @else
            <a href="/admin/maintenance/down" class="c-header-nav-link">Manutenção</a>
            @endif
